...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 03, 2024 lúc 10:47 AM
...
CREATE TABLE `order_details` (
  ...
  `product_name` varchar(255) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `product_size` varchar(50) COLLATE utf8_vietnamese_ci DEFAULT NULL,
